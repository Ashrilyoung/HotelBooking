...
public class room {
    ...
    public void display(int floorNo) {
        System.out.println("Room number: " + floorNo + "0" + roomNos);
        if (status == true) {
    ...
    public void bookroom() {
        ...
        if (status == true) // checks to see if room is free
        {
            ...
            System.out.println("Are you a 1. Regular or 2. Gold customer 3. Employee Customer?");
            ...
            switch (newchoice) {
                ...
                case 2:
                    ...
                    break;
                    case 3:
                    Customer employeePerson = new EmployeeCustomer();
                    status = false;				//makes sure nobody else can too the room
                    occupier = employeePerson;			// attaches the new customers details to the room
                    employeePerson.calcCost(cost);
                    break;
                default:
                    break;
            }
